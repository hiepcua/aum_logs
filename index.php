...
// check permission
if(isLogin()) {
	$g_code = getInfo('gcode');
	if(!in_array($g_code,$_PERMISS_GROUP))
		die('<div style="color: #721c24; background-color: #f8d7da; border-color: #f5c6cb; margin: 1rem; text-align: center; padding: 20px; font-size: 20px;">Bạn không có quyền truy cập.</div>');
}
?>
<!DOCTYPE html>
<html lang='vi'>
<head profile="http://www.w3.org/2005/10/profile">
	...
	<link rel="stylesheet" type="text/css" href="<?php echo ROOTHOST;?>css/form.css"/>
	<link rel="stylesheet" type="text/css" href="<?php echo ROOTHOST;?>css/checkbox.css"/>
	...
	<!-- load tablesorter theme & scripts -->
	<link rel="stylesheet" href="<?php echo ROOTHOST;?>global/tablesorter/css/theme.default.min.css">
	<script type="text/javascript" src="<?php echo ROOTHOST;?>global/tablesorter/js/jquery.tablesorter.min.js"></script>
	<script type="text/javascript" src="<?php echo ROOTHOST;?>global/tablesorter/js/jquery.tablesorter.widgets.min.js"></script>
	<!-- end load tablesorter theme & scripts -->
</head>
...
<script type="text/javascript">
	...
	// view info icon ques
	$(".icon_ques").hover(function(){
		$(this).find(".txt_ques").show();
	}, function() {
		$(this).find(".txt_ques").hide();
	})
