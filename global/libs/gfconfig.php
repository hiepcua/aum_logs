...
define('ROOTHOST_ADMIN',$REQUEST_PROTOCOL.$_SERVER['HTTP_HOST'].'/');
...
$_HOST_LIST=array('wallet.aumsys.net','uid.aumsys.net','student.aumsys.net','edu.aumsys.net','crm.aumsys.net','mkt.aumsys.net','logs.aumsys.net');
